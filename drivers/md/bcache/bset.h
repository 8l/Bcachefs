...
void bch_btree_node_iter_push(struct btree_node_iter *, struct bkey *, struct bkey *);
struct bkey *bch_btree_node_iter_init(struct btree_keys *, struct btree_node_iter *,
				 struct bkey *);
