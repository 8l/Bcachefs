...
rw_attribute(btree_gc_timeouts_enabled);
...
SHOW(bch_cache_set)
{
	...
	sysfs_hprint(btree_node_size,		CACHE_BTREE_NODE_SIZE(&c->sb) << 9);
	sysfs_print(btree_node_size_bytes,	CACHE_BTREE_NODE_SIZE(&c->sb) << 9);
	...
	sysfs_print_time_stats(&c->btree_coalesce_time, btree_coalesce, sec, ms);
	...
	sysfs_printf(btree_gc_timeouts_enabled, "%i", c->gc_timeouts_enabled);
	...
	sysfs_print(pd_controllers_update_seconds, c->pd_controllers_update_seconds);
...
STORE(__bch_cache_set)
{
	...
	sysfs_strtoul(btree_gc_timeouts_enabled, c->gc_timeouts_enabled);
...
static struct attribute *bch_cache_set_internal_files[] = {
	...
	&sysfs_btree_gc_timeouts_enabled,
