...
bool bch_btree_ptr_invalid(struct btree *b, const struct bkey *k)
{
...
bool bch_extent_invalid(struct btree *b, const struct bkey *k)
{
	char buf[80];
...
bool bch_extent_bad(struct btree *b, const struct bkey *k)
{
	struct bucket *g;
	unsigned i, stale;
...
bool bch_extent_merge(struct btree *b, struct bkey *l, struct bkey *r)
{
	unsigned i;
