			      ...
			      uint64_t *start_time)
{
	...
	while (1) {
		...
		/*
		 * There's room in the entry, but not enough for our reservation --
		 * since we haven't added any keys yet, we're at the end of a bucket,
		 * so skip to the end of the bucket
		 */
