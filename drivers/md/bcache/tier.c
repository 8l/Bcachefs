...
{
	unsigned max_in_flight = DFLT_TIERING_IN_FLIGHT;

	c->max_tiering_in_flight = max_in_flight;
	sema_init(&c->tiering_in_flight, max_in_flight);
	bch_scan_keylist_init(&c->tiering_keys,
			      DFLT_TIERING_KEYS_MAX_SIZE);
